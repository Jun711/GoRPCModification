...
func handleRPCC() {
  l, e := net.Listen("tcp", "172.31.31.19:4002")
    if e != nil {
...
func GrabMessagesFromOtherServers() {
  ...
  var lom ListOfMessages
  lom.ReturnAddress = "172.31.31.19:7000"
  b, err := json.Marshal(lom)
  if err != nil {
    fmt.Println(err)
  }
  ...
  cfInfo.ClientIpPort = "172.31.31.19:7000"
  ...
  serv, _ := rpc.Dial("tcp", "172.31.31.19:4000")
...
func main() {
  ...
  // w := bufio.NewWriter(f)
  go handleRPCC()
  l, _ := net.Listen("tcp", "172.31.31.19:3001")
  defer l.Close()
  for {
